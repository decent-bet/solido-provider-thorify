...
import { ThorifyPlugin, ThorifySettings, ThorifySolidoTopic } from '../src';
        ...
        beforeEach(async () => {
            ...
            thor = {
                eth: {
                    Contract: function () { 
                        return {
                            getPastEvents: () => Promise.resolve(1000),
                        }
                    },
                    accounts: {
                        wallet: {
            ...
            tokenContract = token;
            tokenContract.prepareSigning = jasmine.createSpy().and.callThrough();
